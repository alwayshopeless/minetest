local lighting_sections = {
	{n = "shadows", d = "Shadows",
		entries = {
			...
			{n = "main_shadow_factor", d = "Main shadow factor", min = 0.0, max = 1},
			{n = "ambient_occlusion_factor", d = "Ambient occlussion factor", min = 0.0, max = 1},
			{n = "normal_ao_factor", d = "Normal AO factor", min = 0.0, max = 1},
			{n = "ambient_light_color", d = "Ambient light color", min = 0x00000000, max = 0xffffffff}
		}
	},
	{
